...
def vit_update_strategy(model, train_data, optimizer, use_cuda=True, amp=False, clip_grad=None, **kwargs) -> t.Dict:
    ...
    if amp:
        ...
        torch.nn.utils.clip_grad_norm_(ap.master_params(optimizer), clip_grad)
    else:
        total_loss.backward()
